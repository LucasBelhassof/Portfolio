const Projects = () => {
  return (
    ...
    >
      ...
      >
        <li className="mb-2">
          Very famous application among those who work with the MercadoLivre
          platform.
        </li>
        <li className="mb-2">
          Focused on managing multiple market accounts, enabling vizuolizing and
          answering questions in ads and all after-sales messages.
        </li>
        <li className="mb-2">
          The project aims to replicate the main features and design of the
          site.
        </li>
      </ul>
    </div>
